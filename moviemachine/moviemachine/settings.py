# Django settings for moviemachine project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'moviemachine',                     # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'moviemachine.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'moviemachine.wsgi.application'

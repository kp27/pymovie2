...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BoxOffice.estimate'
        db.add_column('machineapp_boxoffice', 'estimate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BoxOffice.estimate'
        db.delete_column('machineapp_boxoffice', 'estimate')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BoxOffice.rank'
        db.alter_column('machineapp_boxoffice', 'rank', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'BoxOffice.rank'
        db.alter_column('machineapp_boxoffice', 'rank', self.gf('django.db.models.fields.IntegerField')(default=0))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BoxOffice.total_gross'
        db.add_column('machineapp_boxoffice', 'total_gross',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Prediction.total_gross'
        db.add_column('machineapp_prediction', 'total_gross',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BoxOffice.total_gross'
        db.delete_column('machineapp_boxoffice', 'total_gross')

        # Deleting field 'Prediction.total_gross'
        db.delete_column('machineapp_prediction', 'total_gross')
